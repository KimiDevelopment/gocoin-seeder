...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "VersaCoin-seeder\n"
...
static const string mainnet_seeds[] = {"seed1.nodeseed.net", "seed2.nodeseed.net", ""};
static const string testnet_seeds[] = {"testnet-seed1.nodeseed.net", ""};
